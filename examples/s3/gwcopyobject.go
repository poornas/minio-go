...
func main() {
	...
	*/
	...
	// Source object
	src := minio.NewSourceInfo("fudmod", "sses3d2s", nil)
	...
	// Destination object
	dst, err := minio.NewDestinationInfo("fudmod", "sses3d2scp", encrypt.NewSSE(), nil)
	if err != nil {
		log.Fatalln(err)
	}
	...
	*/
	/*
				//=========> CASE 3 :::::: plain object on server side to SSEC encrypted object on server side
			...
			// Destination object
			dst, err := minio.NewDestinationInfo("fudmod", "plaind2ssecd2s", encrypt.DefaultPBKDF([]byte("password"), []byte("salt")), nil)
			if err != nil {
				log.Fatalln(err)
			}
	...
	*/
	/*
		...
		dst, err := minio.NewDestinationInfo("fudmod", "sses3d2sssec", encrypt.DefaultPBKDF([]byte("password"), []byte("salt")), nil)
		if err != nil {
			log.Fatalln(err)
		}
	...
	*/
	/*
		...
		// Source object
		src := minio.NewSourceInfo("fudmod", "sses3d2s", nil) //encrypt.DefaultPBKDF([]byte("password"), []byte("salt")))
		...
		dst, err := minio.NewDestinationInfo("fudmod", "sses3d2splain", nil, nil)
		if err != nil {
			log.Fatalln(err)
		}
	...
	*/
	/*
		...
		// Source object
		src := minio.NewSourceInfo("fudmod", "sses3d2splain", nil)
	...
	*/
	...
	// Destination object
	dst, err := minio.NewDestinationInfo("fudmod", "plain2sses3d2", encrypt.NewSSE(), nil)
	if err != nil {
		log.Fatalln(err)
	}
